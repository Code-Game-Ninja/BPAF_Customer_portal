    ...
    <div className="space-y-8 max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden hover:shadow-md transition-all duration-300">
        <div className="px-6 py-5 border-b border-border bg-muted/30 flex items-center gap-3">
          ...
          <h3 className="font-bold text-foreground tracking-tight">Personal Information</h3>
        </div>
        ...
        {loading ? (
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-5 pb-6 border-b border-border">
              <div className="w-16 h-16 rounded-2xl bg-accent flex items-center justify-center text-accent-foreground text-2xl font-bold shadow-sm">
              ...
              <div className="flex flex-col gap-1">
                ...
                {info?.uid && (
                  <p className="text-xs font-medium text-muted-foreground bg-muted px-2 py-1 rounded-lg w-fit">ID: {info.uid}</p>
                )}
              </div>
            </div>
      ...
      <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden hover:shadow-md transition-all duration-300">
        <div className="px-6 py-5 border-b border-border bg-muted/30 flex items-center gap-3">
          ...
          <h3 className="font-bold text-foreground tracking-tight">Change Password</h3>
        </div>
        <form onSubmit={handleChangePassword} className="p-6 space-y-5">
          <div className="space-y-2">
            <label htmlFor="currentPw" className="block text-sm font-semibold text-foreground">
              Current Password
            </label>
            <div className="relative group">
              <input
                ...
                className="w-full px-4 py-2.5 bg-background border border-input rounded-xl text-sm focus:ring-2 focus:ring-ring focus:border-ring outline-none transition-all shadow-sm"
              />
              <button
                type="button"
          ...
          <div className="space-y-2">
            <label htmlFor="newPw" className="block text-sm font-semibold text-foreground">
              New Password
            </label>
            <div className="relative group">
              <input
          ...
          <div className="space-y-2">
            <label htmlFor="confirmPw" className="block text-sm font-semibold text-foreground">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-primary text-primary-foreground text-sm font-bold rounded-xl hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-lg active:scale-[0.98]"
          >
